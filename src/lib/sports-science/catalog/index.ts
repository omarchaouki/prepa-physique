...
export const TEST_BATTERIES: TestBattery[] = [
  {
    ...
    description: {
      fr: "Photographie complète du joueur en début de préparation. Sert de référence pour toute la saison.",
    ...
    when: { fr: "Semaine 1 de la préparation", en: "Week 1 of preseason" },
  },
  {
    key: "midseason_control",
    name: { fr: "Contrôle de mi saison", en: "Mid season control" },
    description: {
      fr: "Version courte pour vérifier le maintien des qualités sans perturber la semaine de match.",
    ...
    when: { fr: "Toutes les 6 à 8 semaines, un jour MD moins 4", en: "Every 6 to 8 weeks, on an MD minus 4 day" },
  },
  {
    key: "injury_prevention",
    name: { fr: "Dépistage du risque de blessure", en: "Injury risk screening" },
    description: {
      fr: "Batterie centrée sur les facteurs de risque modifiables les mieux documentés : force excentrique des ischio jambiers, adducteurs, asymétries et mobilité.",
  ...
  {
    key: "return_to_play",
    name: { fr: "Critères de retour au jeu", en: "Return to play criteria" },
    description: {
      fr: "Tests objectifs à valider avant la réintégration collective après une blessure du membre inférieur.",
    ...
    when: { fr: "Fin de phase de réathlétisation", en: "End of the reconditioning phase" },
  },
  {
    key: "youth_development",
    name: { fr: "Suivi du joueur en formation", en: "Youth development monitoring" },
    description: {
      fr: "Ajoute la maturation biologique aux qualités physiques, pour interpréter les performances à l'aune du stade de croissance.",
  ...
  {
    key: "aerobic_only",
    name: { fr: "Évaluation aérobie", en: "Aerobic assessment" },
    description: {
    ...
    estimatedMinutesPerPlayer: 30,
    when: { fr: "Reprise et retour de trêve hivernale", en: "Preseason and after the winter break" },
  },
];
