...
export const MESSAGES = {
  ...
  "signup.step3": ["Votre acces", "Your access"],
  "signup.stepPosition": ["Etape {current} sur {total}", "Step {current} of {total}"],
  "signup.next": ["Continuer", "Continue"],
  "signup.back": ["Retour", "Back"],
  "signup.country": ["Pays", "Country"],
  "signup.countryHint": [
    "Tapez les premieres lettres.",
  ...
  "signup.countryCount": ["{count} pays proposes", "{count} countries suggested"],
  "signup.jobTitle": ["Votre fonction", "Your role"],
  "signup.jobTitleOther": ["Precisez votre fonction", "Describe your role"],
  "signup.phone": ["Telephone", "Phone"],
  "signup.phoneHint": [
  ...
  "signup.recap": ["Recapitulatif", "Summary"],
  "signup.mismatch": [
